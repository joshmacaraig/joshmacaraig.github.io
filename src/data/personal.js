const personalData = {
  ...
  aboutMe: `I'm a multi-disciplinary builder who turns early ideas into polished, reliable tools. I work across React, Nuxt, Tailwind, WeWeb, Xano, and Webflow depending on what gets the product live fastest.

Most of my work sits inside operations teams - dashboards for area managers, housing platforms for agents, call grading systems, and community portals. I'm usually the person bridging product requirements, UX, and the actual build.

This portfolio highlights those operator-facing dashboards, workflow systems, and collaboration tools so potential partners can quickly see how I approach real product problems.`
};
